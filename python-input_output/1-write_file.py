...
The `write_file` function takes a filename and a string as arguments, writes
the string to the specified file, and returns the number of characters written.
